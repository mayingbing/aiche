...
-(instancetype) initWithItmes:(NSArray<MenuLabel *> *)Itmes
{
    ...
    if (self) {
        ...
        //tel
        UIView *telShowView = [[UIView alloc]initWithFrame:CGRectMake(-200, 0, kW/3, 200)];
        telShowView.layer.cornerRadius = 3;
        telShowView.layer.masksToBounds = YES;
        [self addSubview:telShowView];
        telShowView.backgroundColor = [UIColor colorWithRed:230/255.0 green:80/255.0 blue:123/255.0 alpha:1];
        self.telShowView = telShowView;
        self.isShowTelView = NO;
        [self setShowTelView];
...
-(void)setShowTelView{
    //交警：122
    UILabel *jiaojingTel = [[UILabel alloc]initWithFrame:CGRectMake(5, 20, kW/3-5, 20)];
    ...
    //急救：120
    UILabel *jijiuTel = [[UILabel alloc]initWithFrame:CGRectMake(5, 65, kW/3-5, 20)];
    ...
    //公安：110
    UILabel *gonganTel = [[UILabel alloc]initWithFrame:CGRectMake(5, 110, kW/3-5, 20)];
    ...
    //消防：119
    UILabel *xiaofangTel = [[UILabel alloc]initWithFrame:CGRectMake(5, 155, kW/3-5, 20)];
...
-(void)jumpToTelView{
    if (!_isShowTelView) {
        [UIView animateWithDuration:0.25 animations:^{
            ...
            self.telShowView.frame = CGRectMake(-3, 0, kW/3, 200);
            
            
        } completion:^(BOOL finished) {
            [self bringSubviewToFront:self.telShowView];
            _isShowTelView = YES;
        }];
    }else{
        ...
        [UIView animateWithDuration:0.25 animations:^{
            ...
            self.telShowView.frame = CGRectMake(-200, 0, kW/3, 200);

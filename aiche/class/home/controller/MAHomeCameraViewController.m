...
@interface MAHomeCameraViewController ()<AVCaptureMetadataOutputObjectsDelegate>

@property (strong, nonatomic)   ScanBackgroundView *scanBGView;
...
@implementation MAHomeCameraViewController
